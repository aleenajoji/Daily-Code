...
SELECT * FROM Product_Master WHERE SellingPrice > 2000 AND SellingPrice < 5000;

SELECT Name, City, State FROM Client_Master WHERE State != 'Maharashtra';

SELECT * FROM Client_Master WHERE ClientNo IN ('C00001', 'C00002');

UPDATE Product_Master SET SellingPrice = 1150.50 WHERE Name = '1.44 drive';

DELETE FROM Client_Master WHERE ClientNo = 'C00005';

SELECT * FROM Client_Master WHERE SUBQUERY(City, 2, 1) = 'a';

SELECT COUNT(*) FROM Product_Master WHERE SellingPrice >= 1500;
